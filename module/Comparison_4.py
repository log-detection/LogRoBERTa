...
class SentimentClassifier(nn.Module):
    def __init__(self, n_classes):
        ...
        # Taking the output from both directions
        self.classifier = nn.Linear(256 * 2, n_classes)  # Adjusted for bidirectional
    ...
    def forward(self, input_ids, attention_mask):
        ...
        # LSTM
        lstm_output, (hidden, cell) = self.lstm(roberta_output[0])
